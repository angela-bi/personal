  ...
  return (
    <Container>
      ...
      <Grid container >
        ...
        <br/> <br/>
          <ButtonBase sx={{ width: 0.8}}>
            <Img alt="Mal Demo" src='public/projects/mal-demo.gif' />
          </ButtonBase>
        </Grid> 
        <Grid item xs={8}>
      ...
      <Grid container >
        ...
        <br/>
        <ButtonBase sx={{ width: 0.8}}>
            <Img alt="BYOW Demo" src='public/projects/byow_demo.gif' />
          </ButtonBase>
        </Grid> 
        <Grid item xs={8}>
      ...
      <Grid container >
        ...
        <br/> <br/>
        <ButtonBase sx={{ width: 0.8}}>
            <Img alt="Housing Demo" src='public/projects/housing_demo.gif' />
          </ButtonBase>
        </Grid> 
        <Grid item xs={8}>
      ...
      <Grid container >
        ...
        <br/> <br/>
        <ButtonBase sx={{ width: 0.8}}>
            <Img alt="Recommend Poster" src='public/projects/recommend_poster.png' />
          </ButtonBase>
        </Grid> 
        <Grid item xs={8}>
